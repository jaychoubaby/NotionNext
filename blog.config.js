...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    'c7358804e6de4c32bb7c3ca88445df1a,en:c7358804e6de4c32bb7c3ca88445df1a',
  ...
  SINCE: process.env.NEXT_PUBLIC_SINCE || 1990, // e.g if leave this empty, current year will be used.
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'back', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '风筝在阴天搁浅🪁', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://jaychou.cf', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '风筝在阴天搁浅, 博客', // 网站关键词 英文逗号隔开
